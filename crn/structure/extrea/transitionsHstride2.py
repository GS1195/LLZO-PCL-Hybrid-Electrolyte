...
hysteresis_A = 0.5        # Å: margin to avoid flicker; set 0 to disable
...
# ── Write CSVs ───────────────────────────────────────────────
# per-chunk summary
with open("S2li_transitions_2state_chunks.csv", "w", newline="") as f:
    w = csv.writer(f)
...
# by-side per chunk
with open("S2li_transitions_by_side_chunks.csv", "w", newline="") as f:
    w = csv.writer(f)
    w.writerow(["chunk_id","species","direction","side","count","time_ns"])
    w.writerows(rows_by_side)

# overall totals
with open("S2li_transitions_2state_totals.csv", "w", newline="") as f:
    w = csv.writer(f)
...
with open("S2li_transitions_2state_averages.csv", "w", newline="") as f:
    w = csv.writer(f)
...
with open("S2li_transitions_events.csv", "w", newline="") as f:
    w = csv.writer(f)
...
print("Wrote:")
print("  S2li_transitions_2state_chunks.csv")
print("  S2li_transitions_by_side_chunks.csv")
print("  S2li_transitions_2state_totals.csv")
print("  S2li_transitions_2state_averages.csv")
print("  S2li_transitions_events.csv")
